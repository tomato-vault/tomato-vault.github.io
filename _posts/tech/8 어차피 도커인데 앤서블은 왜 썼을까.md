...
description: "콘솔 클릭의 공포에서 Terraform 2-Step 도입, Ansible을 걷어내고 Docker ECR+ECS와 3중 안전망 스크립트로 1인이 온전히 통제하는 최소한의 인프라를 세우기까지"
date: 2026-09-18
categories: [tech]
tags: ["DevOps", "Terraform", "AWS", "ECS", "Docker", "Architecture", "CI-CD"]
...
## 다음 이야기: AI가 쏟아낸 UI 스파게티를 FSD로 썰어내기까지
...
다음 **[[9편] AI가 쏟아낸 UI 스파게티를 FSD로 썰어내기까지](/tech/9-frontend-fsd/)**에서는, 13만 줄에 달하는 프론트엔드 코드베이스에서 104건의 순환 참조를 걷어내고 Feature-Sliced Design(FSD) 6계층 단방향 의존성 규칙으로 에이전트의 프론트엔드 난개발을 통제한 치열한 아키텍처 리팩터링 여정을 공개한다.
